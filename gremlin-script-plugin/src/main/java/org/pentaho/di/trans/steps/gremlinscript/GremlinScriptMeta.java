...
@Step( id = "GremlinScript", image = "gremlin-script.png", name = "Gremlin Script",
    description = "A scripting step for the Gremlin-Groovy script engine", categoryDescription = "Graph" )
public class GremlinScriptMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  private void readData( Node stepnode ) throws KettleXMLException {
    try {
      ...
      throw new KettleXMLException( BaseMessages.getString( PKG,
          "GremlinScriptMeta.Exception.UnableToLoadStepInfoFromXML" ), e );
    }
  }
  ...
  public void setDefault() {
    ...
    jsScripts[0] =
        new ScriptValuesScript( ScriptValuesScript.TRANSFORM_SCRIPT, BaseMessages.getString( PKG,
            "GremlinScript.Script1" ), "//" + BaseMessages.getString( PKG, "GremlinScript.ScriptHere" ) + Const.CR
            + Const.CR );
        ...
        if ( replace[i] ) {
          ...
          if ( row.searchValueMeta( fieldname[i] ) == null && Const.isEmpty( rename[i] ) ) {
            throw new KettleStepException( BaseMessages.getString( PKG,
                "GremlinScriptMeta.Exception.FieldToReplaceNotFound", fieldname[i] ) );
          }
  ...
  public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases )
    ...
    try {
      ...
      throw new KettleException( BaseMessages.getString( PKG,
          "GremlinScriptMeta.Exception.UnexpectedErrorInReadingStepInfo" ), e );
    }
  }
  ...
  public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step )
    ...
    try {
      ...
      throw new KettleException( BaseMessages.getString( PKG, "GremlinScriptMeta.Exception.UnableToSaveStepInfo" )
          + id_step, e );
    }
  }
  ...
  public void check( List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev,
    ...
    if ( prev != null && strActiveScript.length() > 0 ) {
      cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString( PKG,
              "GremlinScriptMeta.CheckResult.ConnectedStepOK", String.valueOf( prev.size() ) ), stepMeta );
      remarks.add( cr );
      ...
      try {
        ...
        // "GremlinScriptMeta.CheckResult.ScriptCompiledOK"), stepinfo);
        // remarks.add(cr);
        ...
        try {
          ...
          cr =
              new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString( PKG,
                  "GremlinScriptMeta.CheckResult.ScriptCompiledOK2" ), stepMeta );
          remarks.add( cr );

          if ( fieldname.length > 0 ) {
            StringBuffer message =
                new StringBuffer( BaseMessages.getString( PKG, "GremlinScriptMeta.CheckResult.FailedToGetValues",
          ...
          error_message =
              BaseMessages.getString( PKG, "GremlinScriptMeta.CheckResult.CouldNotExecuteScript" ) + Const.CR
                  + jse.toString();
          cr = new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, error_message, stepMeta );
          remarks.add( cr );
        } catch ( Exception e ) {
          // Context.exit(); TODO AKRETION NOT SURE
          error_message =
              BaseMessages.getString( PKG, "GremlinScriptMeta.CheckResult.CouldNotExecuteScript2" ) + Const.CR
                  + e.toString();
          cr = new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, error_message, stepMeta );
          remarks.add( cr );
        }
        ...
        // Context.exit(); TODO AKRETION NOT SURE
        error_message =
            BaseMessages.getString( PKG, "GremlinScriptMeta.CheckResult.CouldNotCompileScript" ) + Const.CR
                + e.toString();
        cr = new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, error_message, stepMeta );
        remarks.add( cr );
      }
    ...
    if ( input.length > 0 ) {
      cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString( PKG,
              "GremlinScriptMeta.CheckResult.ConnectedStepOK2" ), stepMeta );
      remarks.add( cr );
    } else {
      cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString( PKG,
              "GremlinScriptMeta.CheckResult.NoInputReceived" ), stepMeta );
      remarks.add( cr );
    }
  }
    ...
    if ( fieldname[i] != null && fieldname[i].length() > 0 ) {
      ...
      try {
        ...
        message.append( BaseMessages
            .getString( PKG, "GremlinScriptMeta.CheckResult.ErrorRetrievingValue", fieldname[i] )
            + " : " + e.toString() );
        error_found = true;
      }
      res.setLength( length[i], precision[i] );

      message.append( BaseMessages.getString( PKG, "GremlinScriptMeta.CheckResult.RetrievedValue", fieldname[i], res
          .toStringMeta() ) );
    } else {
  ...
  public void parseXmlForAdditionalClasses() throws KettleException {
    try {
      ...
      throw new KettleException( BaseMessages.getString( PKG,
          "GremlinScriptMeta.Exception.UnableToParseXMLforAdditionalClasses" ), e );
    }
  }

...
public class VertexLookupMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public Object clone() {
    VertexLookupMeta retval = (VertexLookupMeta) super.clone();
    return retval;
  }
  ...
  private void readData( Node stepnode ) throws KettleXMLException {
    try {
      ...
      graphField = XMLHandler.getTagValue( stepnode, "graphField" );
      ...
      throw new KettleXMLException( BaseMessages.getString( PKG,
          "VertexLookupMeta.Exception.UnableToLoadStepInfoFromXML" ), e );
    }
  }
      ...
      for ( int i = 0; i < valueName.length; i++ ) {
        ...
        if ( v != null ) // Configuration error/missing resources...
        {
          ...
          throw new KettleStepException( BaseMessages.getString( PKG,
              "VertexLookupMeta.Exception.ReturnValueCanNotBeFound", value[i] ) );
        }
      }
    } else {
      for ( int i = 0; i < valueName.length; i++ ) {
  ...
  public String getXML() {
    ...
    retval.append( "    " + XMLHandler.addTagValue( "graphField", this.getGraphField() ) ); //$NON-NLS-3$
  ...
  public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases )
    ...
    try {
      graphField = rep.getStepAttributeString( id_step, "graphField" );
      ...
      throw new KettleException( BaseMessages.getString( PKG,
          "VertexLookupMeta.Exception.UnexpecteErrorReadingStepInfoFromRepository" ), e );
    }
  }
  ...
  public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step )
    throws KettleException {
    try {
      rep.saveStepAttribute( id_transformation, id_step, "graphField", this.getGraphField() );
      ...
      throw new KettleException( BaseMessages.getString( PKG,
          "VertexLookupMeta.Exception.UnableToSaveStepInfoToRepository" )
          + id_step, e );
    }
  }
  ...
  public void check( List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev,
    ...
    if ( prev != null && prev.size() > 0 ) {
      cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString( PKG,
              "VertexLookupMeta.CheckResult.StepReceivingFields", prev.size() + "" ), stepMeta );
      remarks.add( cr );
      ...
      if ( error_found ) {
        error_message =
            BaseMessages.getString( PKG, "VertexLookupMeta.CheckResult.FieldsNotFound" ) + Const.CR + Const.CR
                + error_message;
        ...
        cr =
            new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString( PKG,
                "VertexLookupMeta.CheckResult.AllFieldsFound" ), stepMeta );
        remarks.add( cr );
      }
    } else {
      cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString( PKG,
              "VertexLookupMeta.CheckResult.CouldNotFindFieldsFromPreviousSteps" ), stepMeta );
      remarks.add( cr );
    }
    ...
    if ( info != null && info.size() > 0 ) {
      cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString( PKG,
              "VertexLookupMeta.CheckResult.StepReceivingLookupData", info.size() + "" ), stepMeta );
      remarks.add( cr );
      ...
      if ( error_found ) {
        error_message =
            BaseMessages.getString( PKG, "VertexLookupMeta.CheckResult.FieldsNotFoundInLookupStream" ) + Const.CR
        ...
        cr =
            new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString( PKG,
                "VertexLookupMeta.CheckResult.AllFieldsFoundInTheLookupStream" ), stepMeta );
        remarks.add( cr );
      }
      ...
      if ( error_found ) {
        error_message =
            BaseMessages.getString( PKG, "VertexLookupMeta.CheckResult.FieldsNotFoundInLookupStream2" ) + Const.CR
                + Const.CR + error_message;
        ...
        cr =
            new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString( PKG,
                "VertexLookupMeta.CheckResult.AllFieldsFoundInTheLookupStream2" ), stepMeta );
        remarks.add( cr );
      }
    } else {
      cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString( PKG,
              "VertexLookupMeta.CheckResult.FieldsNotFoundFromInLookupSep" ), stepMeta );
      remarks.add( cr );
    }

    // See if the source step is filled in!
    if ( Const.isEmpty( this.getGraphField() ) ) {
      cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString( PKG,
              "VertexLookupMeta.CheckResult.SourceStepNotSelected" ), stepMeta );
      remarks.add( cr );
    } else {
      cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString( PKG,
              "VertexLookupMeta.CheckResult.SourceStepIsSelected" ), stepMeta );
      remarks.add( cr );

      // See if the step exists!
      //
      if ( prev != null && prev.searchValueMeta( this.getGraphField() ) != null ) {
        cr =
            new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString( PKG,
                "VertexLookupMeta.CheckResult.SourceStepExist", this.getGraphField() ), stepMeta );
        remarks.add( cr );
      } else {
        cr =
            new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString( PKG,
                "VertexLookupMeta.CheckResult.SourceStepDoesNotExist", this.getGraphField() ), stepMeta );
        remarks.add( cr );
      }
    }
    ...
    if ( input.length >= 2 ) {
      cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString( PKG,
              "VertexLookupMeta.CheckResult.StepReceivingInfoFromInputSteps", input.length + "" ), stepMeta );
      remarks.add( cr );
    } else {
      cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString( PKG,
              "VertexLookupMeta.CheckResult.NeedAtLeast2InputStreams", Const.CR, Const.CR ), stepMeta ); //$NON-NLS-3$
      remarks.add( cr );
    }
  }
  ...
  public StepIOMetaInterface getStepIOMeta() {
    if ( ioMeta == null ) {
      ...
      StreamInterface stream =
          new Stream( StreamType.INFO, null, BaseMessages.getString( PKG, "VertexLookupMeta.InfoStream.Description" ),
